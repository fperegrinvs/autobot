namespace Autotob.Brick
{
	...
	public abstract class MonoBrickException : System.Exception
	{
		...
		/// Error code
		/// </param>
		public MonoBrickException(string description, byte code):base(description){ this.errorCode = code;}
		...
		/// Error code
		/// </param>
		public MonoBrickException(string description, Exception e, byte code):base(description, e){this.errorCode = code;}
