...
#pragma warning restore
    ...
    public class Output
    {
        ...
        {
            this.BitField = bf;
            this.DaisyChainLayer = daisyChainLayer;
        }
        ...
        /// </summary>
        public Output()
            : this(OutputBitfield.OutA, DaisyChainLayer.EV3)
        {
        }
        ...
        public bool IsReady()
        {
            ...
            command.Append(this.DaisyChainLayer);
            command.Append(this.BitField);
            var brickReply = this.connection.SendAndReceive(command);
    ...
    public class MotorBase
    {
        ...
        internal Connection<Command, Reply> Connection
        {
            get { return this.output.Connection; }
            set { this.output.Connection = value; }
        }
        ...
        {
            get { return this.output.DaisyChainLayer; }
            set { this.output.DaisyChainLayer = value; }
        }
        ...
        {
            this.output.SetPower(power, reply);
        }
    }
    ...
    public class Motor : MotorBase, IMotor
    {
        ...
        public bool Reverse
        {
            ...
            set
            {
                ...
                if (this.reverse)
                {
                    this.output.SetPolarity(Polarity.Backward);
                }
                else
                {
                    this.output.SetPolarity(Polarity.Forward);
                }
            }
        }
        ...
        {
            this.On(speed, degrees, brake, false);
        }
        ...
        public void On(sbyte speed, UInt32 degrees, bool brake, bool reply)
        {
            ...
            this.output.SetStepSpeed(speed, rampUpDownSteps, constantsSteps, rampUpDownSteps, brake, reply);
        }
        ...
        {
            this.MoveTo(speed, position, brake, false);
        }
        ...
        {
            Int32 currentPos = this.GetTachoCount();
            UInt32 diff = 0;
            sbyte motorSpeed = 0;
        ...
        {
            this.output.SetStepSpeed(speed, rampUpSteps, constantSpeedSteps, rampDownSteps, brake, reply);
        }
        ...
        {
            this.output.SetTimeSpeed(speed, rampUpTimeMs, constantSpeedTimeMs, rampUpTimeMs, brake, reply);
        }
        ...
        {
            this.output.SetStepPower(power, rampUpSteps, constantSpeedSteps, rampDownSteps, brake, reply);
        }
        ...
        {
            this.output.SetTimePower(power, rampUpTimeMs, constantSpeedTimeMs, rampDownTimeMs, brake, reply);
        }
        ...
        {
            return this.output.GetCount(this.Port);
        }
        ...
        {
            return this.output.GetSpeed(this.Port) != 0;
        }
        ...
        {
            return this.output.GetSpeed(this.Port);
        }
    }
    ...
    public class MotorSync : MotorBase
    {
        ...
        {
            this.output.SetStepSync(speed, turnRatio, steps, brake, reply);
        }
        ...
        {
            this.output.SetTimeSync(speed, turnRatio, timeInMs, brake, reply);
        }
        ...
        {
            this.On(speed, turnRatio, 0, false);
        }
        ...
        public void On(sbyte speed, short turnRatio, bool reply, bool @break = false)
        {
            this.StepSync(speed, turnRatio, 0, @break, reply);
        }
        ...
        {
            this.On(speed, turnRatio, degrees, false);
        }
        ...
        /// <param name="reply">If set to <c>true</c> reply from brick will be send.</param>
        /// <param name="break"></param>
        public void On(sbyte speed, short turnRatio, uint degrees, bool reply, bool @break = false)
        {
            this.StepSync(speed, turnRatio, degrees, @break, reply);
        }
    }
    ...
    public class Vehicle : IVehicle
    {
        ...
        internal Connection<Command, Reply> Connection
        {
            ...
            set
            {
                ...
                this.motorSync.Connection = value;
            }
        }
        ...
        public MotorPort LeftPort
        {
            ...
            {
                this.leftPort = value;
                this.motorSync.BitField = this.motorSync.MotorPortToBitfield(this.leftPort) | this.motorSync.MotorPortToBitfield(this.rightPort);
            }
        }
        ...
        {
            this.Move((sbyte)-speed, 0, false, false);
        }
        ...
        {
            this.Backward((sbyte)-speed, 0, reply);
        }
        ...
        {
            this.Move((sbyte)-speed, degrees, reply, false);
        }
        ...
        {
            this.Forward(speed, 0, reply, false);
        }
        ...
        /// <param name="break"></param>
        public void Forward(sbyte speed, uint degrees, bool reply, bool @break)
        {
            this.Move(speed, degrees, reply, @break);
        }
        ...
        {
            if (this.leftPort < this.rightPort)
            {
                this.HandleSpinLeft(speed, degrees, reply);
            }
            else
            {
                this.HandleSpinRight(speed, degrees, reply);
            }
        }
        ...
        {
            this.TurnRightForward(speed, turnPercent, false);
        }
        ...
        /// </param>
        /// <param name="break"></param>
        public void TurnRightForward(sbyte speed, sbyte turnPercent, bool reply, bool @break = false)
        {
            if (this.leftPort < this.rightPort)
            {
                this.HandleRightForward(speed, turnPercent, 0, reply, @break);
            }
            else
            {
                this.HandleLeftForward(speed, turnPercent, 0, reply, @break);
            }
        }
        ...
        /// <param name="reply">If set to <c>true</c> reply will be send.</param>
        /// <param name="break"></param>
        public void TurnRightForward(sbyte speed, sbyte turnPercent, uint degrees, bool reply = false, bool @break = false)
        {
            if (this.leftPort < this.rightPort)
            {
                this.HandleRightForward(speed, turnPercent, degrees, reply, @break);
            }
            else
            {
                this.HandleLeftForward(speed, turnPercent, degrees, reply, @break);
            }
        }
        ...
        {
            this.TurnRightReverse(speed, turnPercent, false);
        }
        ...
        {
            this.TurnRightReverse(speed, turnPercent, 0, reply);
        ...
        public void TurnRightReverse(sbyte speed, sbyte turnPercent, UInt32 degrees, bool reply = false)
        {
            if (this.leftPort < this.rightPort)
            {
                this.HandleRightReverse(speed, turnPercent, degrees, reply);
            }
            else
            {
                this.HandleLeftReverse(speed, turnPercent, degrees, reply);
            }
        }
        ...
        {
            this.TurnLeftForward(speed, turnPercent, false);
        }
        ...
        {
            this.TurnLeftForward(speed, turnPercent, 0, reply: reply);
        }
        ...
        /// <param name="reply">If set to <c>true</c> reply will be send.</param>
        /// <param name="break"></param>
        public void TurnLeftForward(sbyte speed, sbyte turnPercent, uint degrees, bool reply = false, bool @break = false)
        {
            if (this.leftPort < this.rightPort)
            {
                this.HandleLeftForward(speed, turnPercent, degrees, reply, @break);
        ...
        {
            this.TurnLeftReverse(speed, turnPercent, false);
        }
        ...
        {
            this.TurnLeftReverse(speed, turnPercent, 0, reply);
        }
        ...
        private void HandleLeftForward(sbyte speed, sbyte turnPercent, uint degrees, bool reply, bool @break = false)
        {
            if (!this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, (short)-turnPercent, degrees, reply, @break);
            }
            if (!this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, (short)((short)-200 + (short)turnPercent), degrees, reply, @break);
            }
            if (this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, (short)((short)-200 + (short)turnPercent), degrees, reply, @break);
            }
            if (this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, (short)-turnPercent, degrees, reply, @break);
            }
        }

        private void HandleRightForward(sbyte speed, sbyte turnPercent, uint degrees, bool reply, bool @break = false)
        {
            if (!this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, (short)turnPercent, degrees, reply, @break);
        ...
        private void HandleLeftReverse(sbyte speed, sbyte turnPercent, UInt32 degrees, bool reply)
        {
            if (!this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, (short)-turnPercent, degrees, reply);
            }
            if (!this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)speed, (short)((short)-200 + (short)turnPercent), degrees, reply);
            }
            if (this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, (short)((short)-200 + (short)turnPercent), degrees, reply);
            ...
            if (this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On(speed, (short)-turnPercent, degrees, reply);
            }
        }
        ...
        private void HandleSpinRight(sbyte speed, UInt32 degrees, bool reply)
        {
            if (!this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, 200, degrees, reply);
            }
            if (!this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On(speed, (short)0, degrees, reply);
            }
            if (this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, 0, degrees, reply);
            }
            if (this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, 200, degrees, reply);
            }
        }
        ...
        private void HandleSpinLeft(sbyte speed, UInt32 degrees, bool reply)
        {
            ...
            if (!this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, (short)0, degrees, reply);
            }
            if (this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, 0, degrees, reply);
            }
            if (this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, -200, degrees, reply);
        ...
        private void Move(sbyte speed, uint degrees, bool reply, bool @break)
        {
            if (!this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, 0, degrees, reply, @break);
            }
            if (!this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On(speed, (short)200, degrees, reply, @break);
            }
            if (this.ReverseLeft && !this.ReverseRight)
            {
                this.motorSync.On(speed, -200, degrees, reply, @break);
            }
            if (this.ReverseLeft && this.ReverseRight)
            {
                this.motorSync.On((sbyte)-speed, 0, degrees, reply, @break);
            }
        }
    }
}
