        ...
        protected override double GetCurrentValueCore(double defaultOriginValue, double defaultDestinationValue, AnimationClock animationClock) {
            ...
            switch (this.EdgeBehavior) {
                case EdgeBehavior.EaseIn:
                    returnValue = EaseIn(timeFraction, start, delta, this.Power);
                    break;
                case EdgeBehavior.EaseOut:
                    returnValue = EaseOut(timeFraction, start, delta, this.Power);
                    break;
                case EdgeBehavior.EaseInOut:
                default:
                    returnValue = EaseInOut(timeFraction, start, delta, this.Power);
                    break;
            }
            return returnValue;
        }
